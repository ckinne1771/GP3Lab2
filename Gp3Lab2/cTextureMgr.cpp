...
{
	cTextureMgr::GLTextureID = NULL;
}

cTextureMgr::cTextureMgr(LPCSTR theFilename)
{
	cTextureMgr::createTexture(theFilename);
}
...
=================
*/
bool cTextureMgr::createTexture(LPCSTR theFilename) 	// create the texture for use.
{
...
=================
*/
GLuint cTextureMgr::getTexture()        // return the texture.
{
	return cTextureMgr::GLTextureID;
}
...
=================
*/
GLsizei cTextureMgr::getTWidth() 						// Return width of texture;
{
	return textureWidth;
}
/*
...
=================
*/
GLsizei cTextureMgr::getTHeight() 						// Return height of texture;
{
